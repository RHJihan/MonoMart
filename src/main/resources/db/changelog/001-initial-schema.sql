...
--changeset monomart:005-create-user-addresses-table
...
--changeset monomart:006-create-order-addresses-table
...
--changeset monomart:007-create-orders-table
CREATE TABLE orders
(
    id           BIGSERIAL PRIMARY KEY,
    user_id      BIGINT         NOT NULL REFERENCES users (id),
...
--changeset monomart:008-create-order-items-table
...
--changeset monomart:009-create-payments-table
